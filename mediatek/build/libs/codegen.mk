...
$(eval $(call mtk-cgen-AutoGenHeaderFile,$(MTK_CGEN_cfg_module_file_dir),$(MTK_CGEN_cfg_module_file),,$(OUT_DIR)/target/product/$(PROJECT)/obj/include/dfo/CFG_Dfo_File.h))
$(eval $(call mtk-cgen-AutoGenHeaderFile,$(MTK_CGEN_cfg_module_default_dir),$(MTK_CGEN_cfg_module_default),,$(OUT_DIR)/target/product/$(PROJECT)/obj/include/dfo/CFG_Dfo_Default.h))
...
$(MTK_CGEN_AP_Temp_CL): $(OUT_DIR)/target/product/$(PROJECT)/obj/include/dfo/CFG_Dfo_File.h
$(MTK_CGEN_AP_Temp_CL): $(OUT_DIR)/target/product/$(PROJECT)/obj/include/dfo/CFG_Dfo_Default.h
