...
# added by mingzhi.shen, compile phone module when TCL_TELEPHONY_SUPPORT=true
ifeq ($(TCL_TELEPHONY_SUPPORT),true)
export MTK_TB_APP_CALL_FORCE_SPEAKER_ON=yes
export MTK_TTY_SUPPORT=yes
export RESOURCE_OVERLAY_SUPPORT=generic navbar tablet
export MTK_VT3G324M_SUPPORT=yes
export TCT_SETTINGS_CALL=yes
export MTK_BT_PROFILE_HFP=yes
endif
