...
/*
	u32 base = I2C2_BASE; 
	return (__raw_readw(mt_I2C_HS) << 16) | (__raw_readw(mt_I2C_TIMING));
*/
}
/*----------------------------------------------------------------------------*/
/*
int al3006_config_timing(int sample_div, int step_div)
{
	...
	return (__raw_readw(mt_I2C_HS) << 16) | (tmp);
}*/
/*----------------------------------------------------------------------------*/
