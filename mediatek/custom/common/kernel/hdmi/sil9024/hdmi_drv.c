...
#define GPIO_HDMI_5VPOWER_EN GPIO12
#define GPIO_HDMI_LCD_SW_EN GPIO113
#define GPIO_HDMI_9024_RESET GPIO112
...
int sii9024_power_on(void)  //sii9024 suspend
{
    ...
    mt_set_gpio_mode(GPIO_HDMI_5VPOWER_EN, GPIO_MODE_00);
    mt_set_gpio_dir(GPIO_HDMI_5VPOWER_EN, GPIO_DIR_OUT);
    mt_set_gpio_out(GPIO_HDMI_5VPOWER_EN, GPIO_OUT_ONE);
...
void sii9024_power_off(void)  //sii9024 resume
{
    ...
    mt_set_gpio_mode(GPIO_HDMI_5VPOWER_EN, GPIO_MODE_00);
    mt_set_gpio_dir(GPIO_HDMI_5VPOWER_EN, GPIO_DIR_OUT);
    mt_set_gpio_out(GPIO_HDMI_5VPOWER_EN, GPIO_OUT_ZERO);
			...
			const struct i2c_device_id *id)
{
	...
	printk("MediaTek HDMI i2c probe\n");	
