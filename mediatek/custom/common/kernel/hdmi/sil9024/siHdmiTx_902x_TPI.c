...
{
	byte Readnum;
	Readnum = sii9024_i2c_read_byte(RegOffset);
	return Readnum;
}
...
void ReadBlockTPI (byte TPI_Offset, word NBytes, byte * pData)
{
	...
	sii9024_i2c_read_block(sii902xA, TPI_Offset,pData,NBytes);
}
...
void WriteBlockTPI (byte TPI_Offset, word NBytes, byte * pData)
{
    	...
    	sii9024_i2c_write_block(sii902xA,TPI_Offset, pData, NBytes);
}
