...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0xb4 , 0x20);
	...
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0x4f , 0x00);
	GC2035_write_cmos_sensor(0x4d , 0x36);
	...
	GC2035_write_cmos_sensor(0x5b , 0x18); //AWB_gain_delta///02
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x76);
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
