...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dsi.vertical_sync_active				= 10;//0;
    params->dsi.vertical_backporch					= 13;//23;
    params->dsi.vertical_frontporch 				= 12;
    params->dsi.vertical_active_line				= (FRAME_HEIGHT+4); 

    params->dsi.horizontal_sync_active				= 120;//0;
    params->dsi.horizontal_backporch				= 100;//160;
    params->dsi.horizontal_frontporch				= 100;//160;
...
LCM_DRIVER nt51018_dsi_vdo_lcm_drv = 
{
    .name           = "nt51018_dsi_vdo",
