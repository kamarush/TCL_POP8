...
HI258_write_cmos_sensor(0x61, 0x7b); //Sat B
HI258_write_cmos_sensor(0x62, 0x80); //Sat R
...
HI258_write_cmos_sensor(0x22, 0x58); //LSC R 1b->15 20130125  57  4c
HI258_write_cmos_sensor(0x23, 0x3b); //LSC G   3c  37
...
void HI258_night_mode(kal_bool enable)	
{
    ...
    if (enable) 
    {
        ...
        if (HI258_Banding_setting == AE_FLICKER_MODE_50HZ) 
        {
	     ...
	     HI258_write_cmos_sensor(0x10, 0x10);
	     HI258_write_cmos_sensor(0x11, 0x93);
...
UINT32 HI258YUVSetVideoMode(UINT16 u2FrameRate)
{
	...
	HI258_write_cmos_sensor(0x90, 0x08); //BLC_TIME_TH_ON
       HI258_write_cmos_sensor(0x91, 0x08); //BLC_TIME_TH_OFF
       HI258_write_cmos_sensor(0x92, 0xa8); //BLC_AG_TH_ON
       HI258_write_cmos_sensor(0x93, 0xa0); //BLC_AG_TH_OFF
       
       HI258_write_cmos_sensor(0x03, 0x02);
       
       HI258_write_cmos_sensor(0xd4, 0x08); //DCDC_TIME_TH_ON
       HI258_write_cmos_sensor(0xd5, 0x08); //DCDC_TIME_TH_OFF 
       HI258_write_cmos_sensor(0xd6, 0xa8); //DCDC_AG_TH_ON
       HI258_write_cmos_sensor(0xd7, 0xa0); //DCDC_AG_TH_OFF
	
       HI258_write_cmos_sensor(0x03, 0x20); 
	HI258_write_cmos_sensor(0x10, 0x1c);
	HI258_write_cmos_sensor(0x18, 0x38);
	HI258_write_cmos_sensor(0x2a, 0xff);
	HI258_write_cmos_sensor(0x2b, 0x34); //Adaptive Off,1/100 Flicker

	HI258_write_cmos_sensor(0x83, 0x02); //EXP Normal 33.33 fps 
       HI258_write_cmos_sensor(0x84, 0xf9); 
       HI258_write_cmos_sensor(0x85, 0xb8); 
       HI258_write_cmos_sensor(0x86, 0x01); //EXPMin 11428.57 fps
       HI258_write_cmos_sensor(0x87, 0xf4); 
       HI258_write_cmos_sensor(0x88, 0x06); //EXP Max 60hz 7.50 fps 
       HI258_write_cmos_sensor(0x89, 0x97); 
       HI258_write_cmos_sensor(0x8a, 0x80); 
       HI258_write_cmos_sensor(0xa5, 0x07); //EXP Max 50hz 7.69 fps 
       HI258_write_cmos_sensor(0xa6, 0xef); 
       HI258_write_cmos_sensor(0xa7, 0x40); 
       HI258_write_cmos_sensor(0x8B, 0xfd); //EXP100 
       HI258_write_cmos_sensor(0x8C, 0xe8); 
       HI258_write_cmos_sensor(0x8D, 0xd2); //EXP120 
       HI258_write_cmos_sensor(0x8E, 0xf0);
       //HI258_write_cmos_sensor(0x91, 0x03); //EXP Limit 816.33 fps 
       //HI258_write_cmos_sensor(0x92, 0x4d); 
       //HI258_write_cmos_sensor(0x93, 0xb4); //EXP Unit 
       HI258_write_cmos_sensor(0xb2, 0xb0);

       HI258_write_cmos_sensor(0x9c, 0x1b); //EXP Limit 816.33 fps 
       HI258_write_cmos_sensor(0x9d, 0x58); 
       HI258_write_cmos_sensor(0x9e, 0x01); //EXP Unit 
       HI258_write_cmos_sensor(0x9f, 0xf4); 
       HI258_write_cmos_sensor(0xa3, 0x00); //Outdoor Int 
       HI258_write_cmos_sensor(0xa4, 0xd2); 
