...
/*@zhi.li.sz add for pro info function 20130917 begin*/
...
/*@zhi.li.sz add for pro info function 20130917 end*/
...
/*@zhi.li.sz add for WiFi-only SN function 20131031 begin*/
typedef struct
{
	char latamimei_trigger[8];
} latamimei_trigger_struct;

typedef struct
{
	char tablet_sn_addr[15];
} tablet_sn_addr_struct;

/*@zhi.li.sz add for WiFi-only SN function 20131031 end*/
...
typedef struct
{
	unsigned char space[_PRODUCT_INFO_SIZE_\
		                ...
		                -sizeof(BT_WIFI_ADDR) \
		                -sizeof(latamimei_trigger_struct) \
		                -sizeof(tablet_sn_addr_struct) \
