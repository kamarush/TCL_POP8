...
kal_uint16 GC0313MIPI_read_cmos_sensor(kal_uint8 addr)
{
	...
	if (0 != iReadRegI2C(&puSendCmd , 1, (u8*)&get_byte, 1, GC0313MIPI_READ_ID)) {
        SENSORDB("ERROR: GC0313MIPI_read_cmos_sensor \n");
	}
    return get_byte;
}
	...
	else 
	{
		...
		if(GC0313MIPI_MPEG4_encode_mode == KAL_TRUE)
			...
			GC0313MIPI_write_cmos_sensor(0x33, 0x20);
           	       GC0313MIPI_write_cmos_sensor(0xfe, 0x00);
			GC0313MIPIGammaSelect(GC0313MIPI_RGB_Gamma_m3);				   
...
void GC0313MIPI_Sensor_Init(void)
{
	...
	////////////////// Analog & CISCTL //////////////////
	/////////////////////////////////////////////////////
	GC0313MIPI_write_cmos_sensor(0x17 , 0x17); 
	...
	GC0313MIPI_write_cmos_sensor(0xb0 , 0x12);
	GC0313MIPI_write_cmos_sensor(0xb1 , 0x26);
	GC0313MIPI_write_cmos_sensor(0xb2 , 0x08);
	GC0313MIPI_write_cmos_sensor(0xb3 , 0xf6);
	GC0313MIPI_write_cmos_sensor(0xb4 , 0xea);
	GC0313MIPI_write_cmos_sensor(0xb5 , 0x20);
	GC0313MIPI_write_cmos_sensor(0xb6 , 0x1f);
	GC0313MIPI_write_cmos_sensor(0xb7 , 0xe4);
	...
	GC0313MIPI_write_cmos_sensor(0x95 , 0x64); //0x86
	...
	GC0313MIPI_write_cmos_sensor(0xd1 , 0x2c);//0x30  0x36
	GC0313MIPI_write_cmos_sensor(0xd2 , 0x28);//0x30  0x36
	GC0313MIPI_write_cmos_sensor(0xd3 , 0x38);//0x34
	GC0313MIPI_write_cmos_sensor(0xd5 , 0x08);//
	...
	GC0313MIPI_write_cmos_sensor(0x54 , 0x02);  //  0x10
	GC0313MIPI_write_cmos_sensor(0x55 , 0x28);  //  0x20
	...
	GC0313MIPI_write_cmos_sensor(0x72 , 0x21); //0101   0X25
	...
	GC0313MIPI_write_cmos_sensor(0x79 , 0x18); //x1 
	GC0313MIPI_write_cmos_sensor(0x7a , 0x40); //x2
	GC0313MIPI_write_cmos_sensor(0x7b , 0xb0); //y1
	GC0313MIPI_write_cmos_sensor(0x7c , 0xf5); //y2
...
{
    	GC0313MIPIGammaSelect(GC0313MIPI_RGB_Gamma_m3);//0:use default
}
...
BOOL GC0313MIPI_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:		
			GC0313MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0313MIPI_write_cmos_sensor(0x13, 0x50);
			GC0313MIPI_write_cmos_sensor(0xfe, 0x00);
			GC0313MIPI_write_cmos_sensor(0xd5, 0x08);
		break;
