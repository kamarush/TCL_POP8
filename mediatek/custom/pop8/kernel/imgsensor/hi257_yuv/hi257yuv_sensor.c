...
HI257WriteCmosSensor(0x42, 0x02); //Cb Offset
HI257WriteCmosSensor(0x43, 0x02); //Cr Offset
...
HI257WriteCmosSensor(0x88, 0x0c); //EXP Max(120Hz) 8.00 fps 
HI257WriteCmosSensor(0x89, 0x5f); 
HI257WriteCmosSensor(0x8a, 0xd0); 

HI257WriteCmosSensor(0xa5, 0x0b); //EXP Max(100Hz) 8.33 fps 
HI257WriteCmosSensor(0xa6, 0xe5); 
...
HI257WriteCmosSensor(0x42, 0x02);
HI257WriteCmosSensor(0x43, 0x02);
HI257WriteCmosSensor(0x44, 0x80);
HI257WriteCmosSensor(0x45, 0x80);
      break;
    case MEFFECT_SEPIA:
...
void HI257set_brightness(UINT16 para)
{
    ...
    {
        case ISP_BRIGHT_LOW:
		HI257WriteCmosSensor(0x70, 0x38);
	spin_lock(&hi257_drv_lock); 
	//  HI257Status.Brightness = 0xa0;
	spin_unlock(&hi257_drv_lock);
             break;
        case ISP_BRIGHT_HIGH:
		HI257WriteCmosSensor(0x70, 0x68); 
		spin_lock(&hi257_drv_lock); 
	...
	spin_unlock(&hi257_drv_lock);
        ...
        default:
		HI257WriteCmosSensor(0x70, 0x48);
		spin_lock(&hi257_drv_lock); 
		//HI257Status.Brightness = 0x00;
	spin_unlock(&hi257_drv_lock);
             break;
...
HI257WriteCmosSensor(0x83, 0x01); //EXP Normal 33.33 fps 
HI257WriteCmosSensor(0x84, 0x7c); 
HI257WriteCmosSensor(0x85, 0xdc); 
...
HI257WriteCmosSensor(0xa5, 0x05); //EXP Max(100Hz) 8.33 fps 
...
HI257WriteCmosSensor(0x90, 0x07); //BLC_TIME_TH_ON
HI257WriteCmosSensor(0x91, 0x07); //BLC_TIME_TH_OFF
HI257WriteCmosSensor(0x92, 0xe8); //BLC_AG_TH_ON
HI257WriteCmosSensor(0x93, 0xe0); //BLC_AG_TH_OFF

HI257WriteCmosSensor(0x03, 0x02);
HI257WriteCmosSensor(0xd4, 0x07); //DCDC_TIME_TH_ON
HI257WriteCmosSensor(0xd5, 0x07); //DCDC_TIME_TH_OFF 
HI257WriteCmosSensor(0xd6, 0xe8); //DCDC_AG_TH_ON
HI257WriteCmosSensor(0xd7, 0xe0); //DCDC_AG_TH_OFF
...
HI257WriteCmosSensor(0xa5, 0x03); //EXP Max(100Hz) 14.29 fps 
HI257WriteCmosSensor(0xa6, 0x78); 
HI257WriteCmosSensor(0xa7, 0xac); 

HI257WriteCmosSensor(0x91, 0x03); //EXP Fix 13.00 fps
HI257WriteCmosSensor(0x92, 0xd0); 
HI257WriteCmosSensor(0x93, 0x90); 
