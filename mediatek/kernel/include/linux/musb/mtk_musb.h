...
#define USBPHY_READ8(offset)          __raw_readb((void __iomem *)(USB_SIF_BASE+0x800+offset))
#define USBPHY_WRITE8(offset, value)  __raw_writeb(value, (void __iomem *)(USB_SIF_BASE+0x800+offset))
...
#define USBPHY_READ16(offset)          __raw_readw((void __iomem *)(USB_SIF_BASE+0x800+offset))
#define USBPHY_WRITE16(offset, value)  __raw_writew(value, (void __iomem *)(USB_SIF_BASE+0x800+offset))
...
#define USBPHY_READ32(offset)          __raw_readl((void __iomem *)(USB_SIF_BASE+0x800+offset))
#define USBPHY_WRITE32(offset, value)  __raw_writel(value, (void __iomem *)(USB_SIF_BASE+0x800+offset))
