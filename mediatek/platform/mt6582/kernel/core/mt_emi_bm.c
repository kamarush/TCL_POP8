...
void BM_Init(void)
{
    ...
    */
    ...
    if (readl(EMI_ARBB) & 0x00008000) {
        g_cBWL |= 1 << 1;
        mt65xx_reg_sync_writel(readl(EMI_ARBB) & ~0x00008000, EMI_ARBB);
    }
