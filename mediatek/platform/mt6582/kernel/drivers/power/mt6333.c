...
void mt6333_set_rg_vmem_rsv1_5_0(kal_uint8 val)
{
  kal_uint8 ret=0;
  ...
  ret=mt6333_config_interface( (kal_uint8)(MT6333_VMEM_RSV0),
                             (kal_uint8)(val),
                             (kal_uint8)(MT6333_PMIC_RG_VMEM_RSV1_5_0_MASK),
                             (kal_uint8)(MT6333_PMIC_RG_VMEM_RSV1_5_0_SHIFT)
	                         );
  mt6333_unlock();
}
