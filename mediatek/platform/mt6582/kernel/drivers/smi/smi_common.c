...
//    M4U_WriteReg32(REG_SMI_L1ARB0 , 0 , 0xFFF);//2048/4096 BW limiter , soft limiter
    M4U_WriteReg32(REG_SMI_L1ARB0 , 0 , 0);//disable BW limiter for display
...
//    M4U_WriteReg32(REG_SMI_L1ARB3 , 0 , 0x842FFF);// 2048/4096 maximum grant counts, soft limiter, 1 read 1 write outstanding limit
    M4U_WriteReg32(REG_SMI_L1ARB3 , 0 , 0xA11FFF);// 2048/4096 maximum grant counts, soft limiter, 8 read 8 write outstanding limit
...
//Debug - E
    ...
    case SMI_BWC_SCEN_VR:
        ...
        M4U_WriteReg32(REG_SMI_L1ARB3 , 0 , 0x884912);// 274/4096 maximum grant counts, soft limiter, 2 read 2 write outstanding limit [0~10]
...
//            if(0 == clock_is_on(MT_CG_VDEC1_LARB))
            if(0 == (0x1 & M4U_ReadReg32(0xF6000000 , 0xC)))
            {
                SMIMSG("===SMI%d is off===\n" , u4Index);
                continue;
            }
